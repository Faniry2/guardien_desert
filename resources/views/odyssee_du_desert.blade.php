...
<section id="hero">
  ...
  <div class="hero-content">
    <span class="h-eyebrow">Renait-Sens · L'Odyssée du sahara</span>
    <h1 class="h-title">
      Concept Renait-sens 90
      <em id="hero-sub">Là où le silence parle</em>
    </h1>
    <div class="h-div"><span></span><em id="hero-icon">🌙</em><span></span></div>
    <p class="h-slogan">
      <span class="slogan-t sl-night">Le sahara n'a pas de fin...<br>Il commence là où tu poses ton regard.</span>
      <span class="slogan-t sl-dawn">L'aube repeint les dunes en or.<br>Le premier souffle du jour t'appartient.</span>
      <span class="slogan-t sl-noon">Sous le soleil de feu, aucune ombre ne ment.<br>Le sahara révèle tout ce que tu fuis.</span>
    </p>
  </div>
  ...
  <div class="si">
    ...
    <div class="appel-grid">
      <div class="appel-text reveal">
        <p>Renait-Sens est né d'un constat simple : les humains ont besoin de silence pour entendre leur propre voix. Dans le sahara du Tassili, chaque grain de sable est une décision que le vent a prise il y a des millénaires.</p>
...
<section id="timeline">
  <div class="si">
    ...
    <div class="tl-track">
      <div class="tl-step"><div class="sv"><div class="sv-in bg-j1"></div></div><div class="sn"><div class="sn-c">J1</div></div><div class="st"><span class="s-jour">Jour Premier · Arrivée</span><div class="s-t">Le Grand Reset</div><p class="s-d">Arrivée à Djanet. Le silence du Tassili accueille chaque voyageur. On dépose les téléphones, les rôles, les masques.</p><div class="s-meta">⏳ « Éteins le bruit. Le sahara commence ici. Module RESET. »</div></div></div>
...
<section id="djanet">
  ...
  <div class="djanet-c">
    ...
    <a href="{{ route('djanet') }}" class="dj-title-link">
      <h2 class="dj-title">Djanet (Tassili najer)<em>L'horizon qui n'existe pas encore</em></h2>
    </a>
    <p class="dj-sub">Le sahara n'a pas de fin...<br>Rejoins la caravane des Nomades de l'Éveil.</p>
    <div class="dj-btns">
